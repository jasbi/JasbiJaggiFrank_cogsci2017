...
Figure 3 demonstrates the clear relationship between exclusive
...
Next, using Sklearn's Decision Tree Module, we built a predictive model
to train on annotated \emph{or} utterances and predict the exclusivity
of unseen \emph{or} utterances (annotated for intonation and
consistency). Averaged over 100 trials and training on 200 examples, the
average accuracy of a binary tree was 83\%. More remarkably, the tree
achieved an average of 80\% accuracy after training on only 20 examples.
...
\begin{tabular}{rrrrr}
 ...
 & Estimate & Std. Error & t value & Pr($>$$|$t$|$) \\ 
  \hline
(Intercept) & 0.17 & 0.11 & 1.6 & 0.11 \\ 
  x & 2.02 & 0.10 & 19.2 & 0.00 \\ 
   \hline
\end{tabular}
